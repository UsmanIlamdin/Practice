...
# line 1, in <module> TypeError: unpacking() 
...
#Traceback (most recent call last): File "<stdin>", 
# line 1, in <module> TypeError: unpacking()
#  got multiple values for argument 'd' 
unpacking(1, 2, *pair, d=4) 
#Traceback (most recent call last): File "<stdin>",
#  line 1, in <module> TypeError: unpacking() 
# got multiple values for argument 'd'
...
unpacking(1,2,**arg_dict)
#Out:   1 2 3 4 () {'not_a_parameter':75}

unpacking(1,2,*pair,**arg_dict)
#Positionalargumentstakepriorityoveranyotherformofargumentpassing
